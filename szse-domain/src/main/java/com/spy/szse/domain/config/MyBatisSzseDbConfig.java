...
public class MyBatisSzseDbConfig {
    ...
    private DataSource szseDataSource;

    @Bean("szseSqlSessionTemplate")
    ...
    private SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/mybatis/szse/*.xml"));
